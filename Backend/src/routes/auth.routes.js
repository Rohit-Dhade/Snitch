...
import { RegisterController, LoginController, GoogleCallback, GetMe, SetRole } from '../controller/auth.controller.js';
...
Authrouter.post('/set-role', authenticateUser, SetRole);
