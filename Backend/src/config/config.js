...
if(!process.env.PRIVATE_KEY_IMAGEKIT){
  throw new Error("PRIVATE_KEY_IMAGEKIT is not defined in environmental variables.");
...
export const config = {
  ...
  PRIVATE_KEY_IMAGEKIT: process.env.PRIVATE_KEY_IMAGEKIT,
